...
app.initializers.add('litalino-guestengagement', () => {
  app.extensionData.for('litalino-guestengagement').registerSetting({
    setting: 'litalino-guestengagement.coordinates',
    name: 'afterXpost',
    type: 'number',
  ...
  app.extensionData.for('litalino-guestengagement').registerSetting({
    setting: 'litalino-guestengagement.timeout',
    name: 'timeout',
    type: 'number',
  ...
  app.extensionData.for('litalino-guestengagement').registerSetting({
    setting: 'litalino-guestengagement.textchange',
    name: 'tchange',
    type: 'text',
  ...
  app.extensionData.for('litalino-guestengagement').registerSetting({
    setting: 'litalino-guestengagement.BoxTitleChange',
    name: 'BoxTitle',
    type: 'text',
